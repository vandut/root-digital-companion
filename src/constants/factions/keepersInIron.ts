...
export const keepersInIron: Faction = {
  ...
  howToPlay: 'The Keepers in Iron are a slow, deliberate faction on a holy quest. Your entire game revolves around managing a flow of ancient Relics. Your actions are determined by your Retinue, a set of three columns where you place cards from your hand. During Daylight, you execute the actions of the columns where you have cards. This requires careful planning, similar to the Eyrie\'s Decree but more flexible. You must physically move Relics across the map with your warriors, protect them, and deliver them to Waystations (your unique buildings) to score. It is a game of logistics and careful positioning.',
  strategy: 'Efficiency is key. Plan your Retinue carefully to create a smooth path for your relics from the forest to a Waystation. Use your Encamp action to place Waystations in safe, central locations. Remember that each warrior can carry a relic, so you can create caravans. Your "Devout Knights" ability makes you tough to fight when a relic is present, so use that to your advantage when moving through dangerous territory. Scoring is slow at first but accelerates as you recover more valuable relics and complete sets. Don\'t neglect crafting, as Waystations are also excellent crafting pieces.',
  specialAbilities: [
