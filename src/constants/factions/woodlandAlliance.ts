...
export const woodlandAlliance: Faction = {
  ...
  howToPlay: 'The Woodland Alliance operates in the shadows, building a grassroots rebellion. Your economy is based on Supporters—cards from your hand that you "Mobilize" into a separate face-down pile. These Supporters are then spent during your Birdsong to perform your two main actions: Spread Sympathy, which places tokens on the board and is your primary way of scoring, and Revolt, a powerful move that removes all enemy pieces in a sympathetic clearing and establishes a permanent Base. Bases allow you to train Officers, which in turn allow you to take military actions in the Evening. You are a guerrilla force, strong on defense and capable of sudden, explosive uprisings.',
  strategy: 'Your early game is about gaining supporters and spreading sympathy to unpopular clearings (those with lots of enemy pieces) to trigger "Outrage" and get free supporters. Avoid direct conflict until you are ready. Your "Guerrilla War" ability makes you a nightmare to attack. Choose your revolt locations carefully; a well-placed base can secure a region and give you a new front for training and military operations. Your hand size is your lifeblood—more cards mean more supporters, so protect clearings where you can gain card advantage.',
  specialAbilities: [
      ...
      actions: [
        ...
        },
        {
          ...
          details: [
            ...
            "Strategic Note: Officers are your bottleneck for military action. You must build a base and then train to be able to Move, Battle, Recruit, or Organize in the Evening."
          ]
        }
      ]
    },
