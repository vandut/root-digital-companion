...
export const lordOfTheHundreds: Faction = {
  ...
  howToPlay: 'The Lord of the Hundreds is a hyper-aggressive warlord faction. Your goal is to aggressively clear out enemies and establish total dominance over clearings to maximize your Oppress scoring each evening. You are a snowballing threat; as you acquire more items for your Hoard, you gain more actions, making you more powerful. Your Warlord is your key piece, leading the charge with the Advance action, a combined move and battle that can quickly overwhelm opponents.',
  strategy: 'Aggression is your only path. Your early game should focus on looting items from ruins or other players to power up your Hoard. Choose your Mood carefully to counter your opponents or press your advantage. The Incite action is powerful for softening up well-defended clearings before your main attack. Your goal is to create a large, contiguous territory free of enemies. You are a major target, so be prepared to defend your Warlord and your Strongholds, which are your main source of recruiting.',
  specialAbilities: [
