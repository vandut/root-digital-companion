...
export const vagabond: Faction = {
  ...
  howToPlay: 'The Vagabond is a single pawn playing an RPG in the middle of a war game. You do not have warriors and cannot rule clearings. Your entire turn is dictated by your inventory of Items. You exhaust (flip face-down) items like Boots to move, Swords to battle, and Torches to explore ruins for more items. By Aiding other factions (giving them cards), you improve your Relationship with them, scoring points and eventually becoming Allied, which allows you to move and fight with their warriors. Conversely, attacking a faction makes them Hostile, letting you score points for fighting them, but making it harder to move through their territory. You are an opportunistic agent of chaos or order, depending on your playstyle.',
  strategy: 'Your character choice at setup will heavily influence your strategy. Some Vagabonds are better at fighting, others at questing or aiding. Your early game should focus on exploring ruins to build your item collection. Don\'t be afraid to take a little damage; ending your turn in a forest allows you to repair all your items for free. Aiding is your most reliable source of points and items from other players. Target a player who is crafting a lot to get good items. Forming a Coalition is a powerful late-game move; find the player in second place who is struggling and offer them an alliance to secure a shared win.',
  specialAbilities: [
