...
export const undergroundDuchy: Faction = {
  ...
  howToPlay: 'The Underground Duchy is a faction of nobles aiming to win popular support. Your key mechanic is swaying Ministers. Each minister provides a powerful, free action during Daylight but must first be "Swayed" by revealing cards that match clearings where you have pieces. The more influential the minister, the more cards you must reveal. You also command the Burrow, an off-map clearing where you can recruit warriors safely and then deploy them anywhere on the map via Tunnels. Your greatest weakness is the "Price of Failure": if an enemy removes one of your buildings (Citadels or Markets), you lose your highest-ranking minister, a devastating setback.',
  strategy: 'Your strategy should be a balance of military expansion and political influence. Use the Dig action to create tunnels, expanding your reach across the map. This makes it easier to meet the suit requirements to sway powerful ministers. Protect your buildings at all costs! A single lost building can cost you a top-tier minister and the crown needed to sway another. Focus on swaying ministers that complement your board state and strategy. For example, if you control many clearings of one suit, the Banker can be a massive source of points.',
  specialAbilities: [
