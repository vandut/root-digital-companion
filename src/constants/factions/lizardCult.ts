...
export const lizardCult: Faction = {
  ...
  howToPlay: 'The Lizard Cult is a faction that thrives on the actions of others. All discarded cards go to a central "Lost Souls" pile. In your Birdsong, the most numerous suit in this pile becomes the "Outcast" suit. This suit is what you can manipulate. Your acolytes (gained when your warriors die on defense) can perform Conspiracies in Outcast clearings. In Daylight, you reveal cards from your hand to perform Rituals (Build gardens, Recruit warriors, or Score points). The more you can match your actions to the whims of the Lost Souls pile, the more powerful you become. Ruling clearings with gardens gives you immense board control.',
  strategy: 'Your goal is to manipulate the "Outcast" suit to your advantage. You want it to be a suit where you can build a lot of gardens, so you can score big. Pay close attention to what other players are discarding. You are weak in battle, so use your "Revenge" ability to your advantage—losing defenders gives you acolytes for powerful conspiracies. Your "Pilgrims" ability is one of the strongest in the game; a single garden lets you rule a clearing. Use this to block other factions from building and moving. Try to persuade other players to discard cards of the suit you need to become the Outcast.',
  specialAbilities: [
    ...
    { title: 'The Lost Souls Pile', description: 'Whenever any player spends or discards a card, it goes to the Lost Souls pile instead of the discard. This pile determines your Outcast suit.' },
  ],
  setup: [
