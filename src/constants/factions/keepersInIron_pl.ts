...
export const keepersInIron_pl: Faction = {
  ...
  setup: [
    ...
    "Place Warriors: Umieść 4 wojowników na polanie w narożniku i 4 kolejne na sąsiedniej polanie przy krawędzi mapy.",
    "Wsuń Wiernych Sług: Wsuń po jednej karcie Wiernego Sługi do każdej kolumny Świty na swojej planszy.",
    "Collect Waystations: Umieść swoje trzy żetony Posterunków na planszy frakcji.",
  ],
  turn: {
    [GamePhase.BIRDSONG]: {
      actions: [
