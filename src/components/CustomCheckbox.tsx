...
export const CustomCheckbox: React.FC<CustomCheckboxProps> = ({ id, label, description, checked, onChange, className = '' }) => {
  return (
    <label htmlFor={id} className={`flex items-start cursor-pointer ${className}`}>
      <input
        id={id}
